<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonDataManage.aspx.cs" Inherits="Mi_gangUI.SystemManage.CommonDataManage" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="5px" EnableCollapse="true"
            ...
            <Items>
                <f:Form ID="Form5" ShowBorder="False" BodyPadding="5px" AnchorValue="100%"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TextBox ID="txt_commonSettingName" Label="名称" runat="server" EmptyText="请输入名称">
                                </f:TextBox>
                ...
                <f:Panel ID="Panel8" ShowBorder="True" ShowHeader="false" AnchorValue="100% -68"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" Title="公共数据管理"  EnableCollapse="true" PageSize="15" ShowBorder="true" ShowHeader="true"
                            AllowPaging="true" runat="server" 
                            DataKeyNames="ID,Name" IsDatabasePaging="true"  OnPageIndexChange="Grid1_PageIndexChange">
                            <Columns>
                                <f:RowNumberField />
                                <f:BoundField Width="10px" DataField="ID" SortField="ButtonID" DataFormatString="{0}"
                                    HeaderText="id" Hidden="true" />
                                <f:BoundField Width="300px" DataField="Name" SortField="Name" DataFormatString="{0}"
                                    HeaderText="名称" />
                                <f:BoundField Width="500px" SortField="value" DataField="value" HeaderText="值" />
                            </Columns>
                        </f:Grid>
                    </Items>
                </f:Panel>
        ...
        <f:Window ID="Window1" IconUrl="~/res/images/16/10.png" runat="server" Hidden="true"
            WindowPosition="Center" IsModal="true" Title="公共数据修改" EnableMaximize="true"
